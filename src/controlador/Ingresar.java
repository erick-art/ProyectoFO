...
public class Ingresar extends JPanel{
	...
	public Ingresar() {
		...
		JLabel lblNewLabel_1 = new JLabel("<html><body>Si usted desea ingresar un nuevo empleado, deberá ingresar los datos que se le solicitan,"
				+ " cerciórese que estén correctos y presione el botón ‘Guardar’.</body></html>");
