...
public class Login extends JFrame{
	...
	public void TryLogin() {
		...
		switch(status) {
			...
			case 2:{
				logWar.setText("<html><body>Ingrese una contraseña de al menos 8 caracteres.</body></html>");
			} break;
			...
			case 4:{
				logWar.setText("<html><body>La contraseña que usted proporciono no es correcta</body></html>");
			} break;
	...
	public void TryRegister() {
		...
		switch(status) {
			...
			case 6:{
				regWar.setText("<html><body>Ingrese una contraseña de al menos 8 caracteres</body></html>");
			}break;
			
			case 7:{
				regWar.setText("<html><body>Ingrese una contraseña de al menos 8 caracteres en el campo de verificar contraseña</body></html>");
			}break;
			...
			case 9:{
				regWar.setText("<html><body>Las contraseñas proporcionadas no son identicas</body></html>");
			}break;
