		...
		*/
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(username.getText()=="Cedula"&&String.valueOf(userpass.getPassword())=="Password") {
					String Contarse̱a =(String.valueOf(userpass.getPassword()));
					for (int i = 0; i <Main. Mis_Usuario.size(); i++) {
						if (Main.Mis_Usuario.get(i).getPASSWORD().equals(Contarse̱a) && Main.Mis_Usuario.get(i).getCedula().equals(username.getText())) {
							Encotrado=true;
					...
					if(Encotrado==false){
						JOptionPane.showMessageDialog(null,"El usuario o la contrase̱a se incorrecta");
					}
				}else {
					JOptionPane.showMessageDialog(null,"Ingrese contrase̱a o cedula");
				}
			}
			*/	
		...
		btnRegistrarse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(regCedula.getText()=="Minimo 9 digitos"&&regNombre.getText()=="Ingrese su nombre"&&regApellido.getText()=="Ingrese su apellido"&&regContro.getText()!="Ingrese una contrase̱a"&&regContro.getText()!="Repita la contrase̱a") {
					String Contarse̱a =(String.valueOf(regContro.getText()));
					for (int i = 0; i < Main.Mis_Usuario.size(); i++) {
					
						System.out.println(Contarse̱a+" y pass"+Main.Mis_Usuario.get(i).getPASSWORD()+" and user "+Main.Mis_Usuario.get(i).getCedula()); 
					...
					if(Encotrado==false) {
						if(Contarse̱a.equals(String.valueOf(verContra.getText()))) {
							Nuevo_Pana.setCedula(regCedula.getText());
					
							Nuevo_Pana.setPASSWORD(Contarse̱a);
